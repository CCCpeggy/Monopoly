...
const string Draw::playerItemTitle[2] = { "項目","數量" };
const string Draw::itemName[2] = { "遙控骰子","路障" };
const string Draw::stockTradeInfo[6] = { "名稱","股價","漲跌","持有","　","　" };
...
const string Draw::houseLevelSymbol[4] = { "　","Ⅰ","Ⅱ","Ⅲ" };
